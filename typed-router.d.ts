...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'front-pages-campaign': RouteRecordInfo<'front-pages-campaign', '/front-pages/campaign', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-advanced': RouteRecordInfo<'front-pages-campaign-advanced', '/front-pages/campaign/advanced', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-csvmapping': RouteRecordInfo<'front-pages-campaign-components-advanced-csvmapping', '/front-pages/campaign/components/advanced/CSVMapping', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-import-method': RouteRecordInfo<'front-pages-campaign-components-advanced-import-method', '/front-pages/campaign/components/advanced/ImportMethod', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-linkedin-search': RouteRecordInfo<'front-pages-campaign-components-advanced-linkedin-search', '/front-pages/campaign/components/advanced/LinkedinSearch', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-lookalike-audience': RouteRecordInfo<'front-pages-campaign-components-advanced-lookalike-audience', '/front-pages/campaign/components/advanced/LookalikeAudience', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-lookalike-dialog': RouteRecordInfo<'front-pages-campaign-components-advanced-lookalike-dialog', '/front-pages/campaign/components/advanced/LookalikeDialog', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-sender-profiles': RouteRecordInfo<'front-pages-campaign-components-advanced-sender-profiles', '/front-pages/campaign/components/advanced/SenderProfiles', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-advanced-upload-csv': RouteRecordInfo<'front-pages-campaign-components-advanced-upload-csv', '/front-pages/campaign/components/advanced/UploadCSV', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-common-campaign-header': RouteRecordInfo<'front-pages-campaign-components-common-campaign-header', '/front-pages/campaign/components/common/CampaignHeader', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-common-campaign-stepper': RouteRecordInfo<'front-pages-campaign-components-common-campaign-stepper', '/front-pages/campaign/components/common/CampaignStepper', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-common-empty-campaign': RouteRecordInfo<'front-pages-campaign-components-common-empty-campaign', '/front-pages/campaign/components/common/EmptyCampaign', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-standard-step-campaign-setup': RouteRecordInfo<'front-pages-campaign-components-standard-step-campaign-setup', '/front-pages/campaign/components/standard/StepCampaignSetup', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-standard-step-target-audience': RouteRecordInfo<'front-pages-campaign-components-standard-step-target-audience', '/front-pages/campaign/components/standard/StepTargetAudience', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-standard-step-workflow-builder': RouteRecordInfo<'front-pages-campaign-components-standard-step-workflow-builder', '/front-pages/campaign/components/standard/StepWorkflowBuilder', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-components-workflow-mode-dialog': RouteRecordInfo<'front-pages-campaign-components-workflow-mode-dialog', '/front-pages/campaign/components/WorkflowModeDialog', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-list': RouteRecordInfo<'front-pages-campaign-list', '/front-pages/campaign/list', Record<never, never>, Record<never, never>>,
    'front-pages-campaign-standard': RouteRecordInfo<'front-pages-campaign-standard', '/front-pages/campaign/standard', Record<never, never>, Record<never, never>>,
    ...
    'front-pages-intricare': RouteRecordInfo<'front-pages-intricare', '/front-pages/intricare', Record<never, never>, Record<never, never>>,
